...
# Este script é um servidor SSH personalizado que aceita conexões de clientes e permite que eles cri
# em túneis dinâmicos (Dynamic Port Forwarding) para qualquer destino que desejarem. Ele utiliza a biblioteca 
# Paramiko para criar um servidor SSH e aceitar conexões.
...
# este servidor como um proxy SOCKS5, ou use um cliente personalizado que suporte túneis dinâmicos para se conectar ao servidor 
# e criar túneis para destinos de sua escolha.  
