### Script: ssh_terminal.py
# Este script é um cliente SSH simples que se conecta a um servidor SSH e fornece um terminal   
#interativo. Ele utiliza a biblioteca Paramiko para criar a conexão SSH, 
# autenticar usando um username e password, e depois entrar em um loop onde o usuário 
# pode digitar comandos que serão executados no servidor remoto. 
